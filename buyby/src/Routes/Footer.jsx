...
function Footer() {
  return (
    <Box mt={20}>
      <Center>
        <Flex w={"100%"} bg={"blackAlpha.100"} padding={10} margin={"auto"}  gap={20}>
          <Box>
            <Text>GET EMAIL OFFERS & THE LATEST NEWS FROM BUYBY </Text>
            <br />
            <Text
              textAlign={"left"}
              whiteSpace={"nowrap"}
      ...
      <Box p={10} bg={"blackAlpha.200"}>
        ...
        <br />
        <br />
        <Text>© 2023 BuyBy, Inc. All Rights Reserved.</Text>
      </Box>
    </Box>
  );
}
